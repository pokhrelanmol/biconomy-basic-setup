    ...
    async function setupSmartAccount() {
        ...
        try {
            const smartAccount = new SmartAccount(web3Provider, {
                activeNetworkId: ChainId.POLYGON_MUMBAI as number,
                supportedNetworksIds: [ChainId.POLYGON_MUMBAI as number],
                networkConfig: [
                    {
                        chainId: ChainId.POLYGON_MUMBAI as number,
                        dappAPIKey: import.meta.env
